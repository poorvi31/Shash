<%-- 
    Document   : AllUser
    Created on : 29-Nov-2023, 10:43:46 am
    Author     : HP
--%>
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="AddBooks.html">AddBook</a>
                                        </nav>
                                    </div>
...
<div class="container mt-5 table-responsive">
    <center><h2>All User Information</h2></center>
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>YY/MM/DD</td>
                <td>Subscribed</td>
                <td>  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Block</button>
                </td>
                <!-- block modal -->
