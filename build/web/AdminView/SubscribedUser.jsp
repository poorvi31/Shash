<%-- 
    Document   : SubscribedUser
    Created on : 29-Nov-2023, 3:55:42 pm
    Author     : HP
--%>
...
<html>
    ...
    <title>Subscribed User information</title>
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
...
<!-- ------------------------------------------------------------------------------------------------------ -->
<center><h1>Subscribed User</h1></center>
...
<!-- Button trigger modal -->
      ...
      <!-- <tfoot class="table-dark">
        <tr>
          ...
          <th scope="col">Subscription date</th>
          <th scope="col">Subscription amount</th>
          <th scope="col">Subscription pack</th>
          <th scope="col">Subscription Expiry</th>
        </tr>
      </tfoot> -->
